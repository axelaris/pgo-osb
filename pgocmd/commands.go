...
// CreateCluster ....
func CreateCluster(APIServerURL, BasicAuthUsername, BasicAuthPassword, clusterName, clientVersion, instanceID, namespace string, AutofailFlag bool, ReplicaCount int) error {
	var err error
